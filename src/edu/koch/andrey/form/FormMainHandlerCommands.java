...
public class FormMainHandlerCommands
{
    ...
    public static final String AC_SELECTFOLDER = "ADDFOLDER";
    ...
    public static final String AC_SAMPLE_SELECT_PATH = "SAMPLE_SELECT_PATH";
      
    public static final String AC_SAVESELECTEDIMG = "SAVE_SELECTED_IMG";
